...
# RDS (postgres, free-tier, only when rds_install_db == "true")
      ...
      environment = [
        {
          ...
          value = var.rds_install_db == "true" ? "jdbc:postgresql://${aws_db_instance.postgres[0].address}:5432/${aws_db_instance.postgres[0].db_name}" : var.spring_datasource_url
        },
        {
          name  = "SPRING_DATASOURCE_USERNAME"
          value = var.rds_install_db == "true" ? var.db_username : var.spring_datasource_username
        },
        {
          name  = "SPRING_DATASOURCE_PASSWORD"
          value = var.rds_install_db == "true" ? var.db_password : var.spring_datasource_password
        },
        {
